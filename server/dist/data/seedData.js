...
const books = [
    ...
    },
    {
        ...
        description: "Cây Cam Ngọt Của Tôi kể về cậu bé Zezé sống cùng gia đình nghèo khó nhưng đầy tình yêu thương. Với trí tưởng tượng phong phú, cậu đã làm bạn với một cây cam ngọt.",
        category: "Tiểu thuyết",
        price: 108000,
        countInStock: 5,
        rating: 4.8,
    ...
    },
    {
        ...
        description: "Sapiens là một chuyến du hành vào lịch sử loài người, từ khi còn là những sinh vật tầm thường sống ở châu Phi cho đến khi trở thành chúa tể của cả thế giới.",
        category: "Lịch sử",
        price: 189000,
        countInStock: 4,
        rating: 4.9,
    ...
    },
    {
        ...
        description: "Nghĩ Giàu Làm Giàu là một trong những cuốn sách bán chạy nhất mọi thời đại. Đây là cuốn sách dạy làm giàu đầu tiên và hay nhất từ trước đến nay.",
        category: "Kinh doanh",
        price: 98000,
        countInStock: 8,
        rating: 4.6,
    ...
    },
    {
        ...
        description: "Vũ Trụ Trong Vỏ Hạt Dẻ là cuốn sách nổi tiếng của nhà vật lý thiên tài Stephen Hawking về các lý thuyết mới nhất trong vật lý hiện đại.",
        category: "Khoa học",
        price: 120000,
        countInStock: 6,
        rating: 4.5,
...
const importData = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const sampleBooks = books.map((book) => {
            ...
            const categoryId = categoryMap.get(book.category) || createdCategories[0]._id;
            return Object.assign(Object.assign({}, book), { user: adminUser, category: categoryId });
        });
        // Thêm books mẫu
        yield Book_1.default.insertMany(sampleBooks);
        // Thêm promotions mẫu
        yield Promotion_1.default.insertMany(promotions);
